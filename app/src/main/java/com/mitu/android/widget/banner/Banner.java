...
import com.mitu.android.widget.banner.listener.OnBannerListener;
import com.mitu.android.widget.banner.loader.ImageLoaderInterface;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mIndicatorHeightSelected;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorWidthSelected = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_width_selected, mIndicatorWidth);
        mIndicatorHeightSelected = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_height_selected, mIndicatorHeight);
        ...
        bannerBackgroundImage = typedArray.getResourceId(R.styleable.Banner_banner_default_image, R.mipmap.ic_default_chang);
        typedArray.recycle();
    }
    ...
    private void createIndicator() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0) {
                params.width = mIndicatorWidthSelected;
                params.height = mIndicatorHeightSelected;
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageSelected(int position) {
        ...
        if (bannerStyle == BannerConfig.CIRCLE_INDICATOR ||
            ...
            unselectedImageView.getLayoutParams().width = mIndicatorWidth;
            unselectedImageView.getLayoutParams().height = mIndicatorHeight;
            ...
            selectedImageView.getLayoutParams().width = mIndicatorWidthSelected;
            selectedImageView.getLayoutParams().height = mIndicatorHeightSelected;
